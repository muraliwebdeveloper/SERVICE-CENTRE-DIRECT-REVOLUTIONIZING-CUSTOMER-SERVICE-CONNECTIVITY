...
function getEmailFromPincode($pincode) {
    ...
    $pincodeEmailsMap = array(
        ...
        '67890' => array('recipient4@example.com', 'recipient5@example.com'),
...
function generateToken($year) {
    ...
    $token = $last_two_digits . "CM0T" . $random_number;
...
$sql = "INSERT INTO mobile_data (name,email,mobile,address,pincode,brand,modelnum,issue,token)
